...
import com.udacity.vinhphuc.musicplayer.presentation.adapters.BaseSongAdapter;
...
public class AppUtils {
    ...
    public static void clearFavouriteTracks(Context context) {
        SongProvider.getInstance(context).deleteAll();
    }
        ...
        new MaterialDialog.Builder(context)
                ...
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        AppUtils.deleteTracks(context, list);
