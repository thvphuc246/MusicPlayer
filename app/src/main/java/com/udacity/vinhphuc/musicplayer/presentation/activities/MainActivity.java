...
import com.udacity.vinhphuc.musicplayer.permissions.PermissionCallback;
import com.udacity.vinhphuc.musicplayer.presentation.cast.ExpandedControlsActivity;
...
import com.udacity.vinhphuc.musicplayer.presentation.fragments.FoldersFragment;
import com.udacity.vinhphuc.musicplayer.presentation.fragments.LyricsFragment;
import com.udacity.vinhphuc.musicplayer.presentation.fragments.MainFragment;
import com.udacity.vinhphuc.musicplayer.presentation.fragments.PlaylistFragment;
import com.udacity.vinhphuc.musicplayer.presentation.fragments.QueueFragment;
    ...
    private void checkPermissionAndThenLoad() {
        ...
        if (Nammu.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE) && Nammu.checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            if (Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(panelLayout, R.string.read_external_storage_message,
