...
import com.udacity.vinhphuc.musicplayer.utils.LyricsExtractor;
import com.udacity.vinhphuc.musicplayer.utils.LyricsLoader;
            ...
            if (artist != null) {
                ...
                LyricsLoader.getInstance(this.getContext()).getLyrics(artist, MusicPlayer.getTrackName(), new Callback<String>() {
                    ...
                    public void success(String s, Response response) {
                        lyrics = s;
                        if (s.equals(R.string.no_lyrics_checking_message)) {
