...
import com.udacity.vinhphuc.musicplayer.presentation.adapters.PlayingQueueAdapter;
...
public class QueueFragment extends Fragment implements MusicStateListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = rootView.findViewById(R.id.fragment_queue_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setItemAnimator(null);
        recyclerView.setEmptyView(getActivity(), rootView.findViewById(R.id.list_empty), getResources().getString(R.string.no_songs_queued));
