...
import com.udacity.vinhphuc.musicplayer.data.listeners.SimplelTransitionListener;
...
import com.udacity.vinhphuc.musicplayer.presentation.adapters.AlbumSongsAdapter;
import com.udacity.vinhphuc.musicplayer.presentation.dialogs.AddPlaylistDialog;
import com.udacity.vinhphuc.musicplayer.utils.ATEUtils;
import com.udacity.vinhphuc.musicplayer.utils.AppUtils;
import com.udacity.vinhphuc.musicplayer.utils.Constants;
import com.udacity.vinhphuc.musicplayer.utils.FabAnimationUtils;
import com.udacity.vinhphuc.musicplayer.utils.Helpers;
import com.udacity.vinhphuc.musicplayer.utils.ImageUtils;
...
public class AlbumDetailFragment extends Fragment {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        MusicPlayer.playAll(getActivity(), adapter.getSongIds(), 0, albumID, AppUtils.IdType.Album, true);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.popup_song_addto_queue:
                MusicPlayer.addToQueue(context, mAdapter.getSongIds(), -1, AppUtils.IdType.NA);
                break;
        ...
        ImageUtils.loadAlbumArtIntoView(album.id, albumArt, new ImageLoadingListener() {
                    ...
                    public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                        ...
                        MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(context)
                                ...
                                .setColor(AppUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                                                                          ...
                                                                          public void onGenerated(Palette palette) {
                                                                              ...
                                                                              if (getActivity() != null) {
                                                                                  MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(getActivity())
                                                                                          ...
                                                                                          .setSizeDp(30);
                                                                                  if (primaryColor != -1) {
                                                                                      builder.setColor(AppUtils.getBlackWhiteColor(primaryColor));
                                                                                      ATEUtils.setFabBackgroundTint(fab, primaryColor);
                                                                                      fab.setImageDrawable(builder.build());
                                                                                  } else {
                                                                                      if (context != null) {
                                                                                          ATEUtils.setFabBackgroundTint(fab, Config.accentColor(context, Helpers.getATEKey(context)));
                                                                                          builder.setColor(AppUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                                                                                          fab.setImageDrawable(builder.build());
                                                                                      }
                                                                                  }
                                                                              }
    ...
    private void setAlbumDetails() {
        ...
        String songCount = AppUtils.makeLabel(getActivity(), R.plurals.Nsongs, album.songCount);
