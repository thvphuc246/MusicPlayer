...
import com.udacity.vinhphuc.musicplayer.widgets.DragSortRecycler;
...
public class PlaylistDetailActivity extends BaseActivity
        implements ATEActivityThemeCustomizer, ATEToolbarCustomizer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (animate && AppUtils.isLollipop()) {
    ...
    private void setAlbumart() {
        ...
        loadBitmap(AppUtils.getAlbumArtUri(getIntent().getExtras().getLong(Constants.ALBUM_ID)).toString());
    }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        if (action.equals(Constants.NAVIGATE_PLAYLIST_USERCREATED)) {
            ...
            menu.findItem(R.id.action_clear_auto_playlist).setTitle(getString(R.string.clear) + " " + playlistname.getText().toString());
        }
    ...
    private void showDeletePlaylistDialog() {
        new MaterialDialog.Builder(this)
                ...
                .content(getString(R.string.are_you_sure_to_delete_playlist) + " " + playlistname.getText().toString() + " ?")
    ...
    private void clearAutoPlaylists() {
        switch (action) {
            case Constants.NAVIGATE_PLAYLIST_LASTADDED:
                AppUtils.clearLastAdded(this);
                break;
            case Constants.NAVIGATE_PLAYLIST_RECENT:
                AppUtils.clearRecent(this);
                break;
