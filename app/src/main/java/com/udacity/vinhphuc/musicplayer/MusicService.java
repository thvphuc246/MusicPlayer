...
import com.udacity.vinhphuc.musicplayer.data.helpers.MediaButtonIntentReceiver;
import com.udacity.vinhphuc.musicplayer.data.helpers.MusicPlaybackTrack;
import com.udacity.vinhphuc.musicplayer.data.providers.MusicPlaybackState;
import com.udacity.vinhphuc.musicplayer.data.providers.RecentStore;
import com.udacity.vinhphuc.musicplayer.data.providers.SongPlayCount;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "com.udacity.vinhphuc.musicplayer.playstatechanged";
    public static final String POSITION_CHANGED = "com.udacity.vinhphuc.musicplayer.positionchanged";
    public static final String META_CHANGED = "com.udacity.vinhphuc.musicplayer.metachanged";
    public static final String QUEUE_CHANGED = "com.udacity.vinhphuc.musicplayer.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.udacity.vinhphuc.musicplayer.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.udacity.vinhphuc.musicplayer.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.udacity.vinhphuc.musicplayer.shufflemodechanged";
    public static final String TRACK_ERROR = "com.udacity.vinhphuc.musicplayer.trackerror";
    public static final String MUSICAPP_PACKAGE_NAME = "com.udacity.vinhphuc.musicplayer";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.udacity.vinhphuc.musicplayer.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.udacity.vinhphuc.musicplayer.togglepause";
    public static final String ACTION_PLAY = "com.udacity.vinhphuc.musicplayer.play";
    public static final String PAUSE_ACTION = "com.udacity.vinhphuc.musicplayer.pause";
    public static final String STOP_ACTION = "com.udacity.vinhphuc.musicplayer.stop";
    public static final String PREVIOUS_ACTION = "com.udacity.vinhphuc.musicplayer.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.udacity.vinhphuc.musicplayer.previous.force";
    public static final String NEXT_ACTION = "fcom.udacity.vinhphuc.musicplayer.next";
    public static final String REPEAT_ACTION = "com.udacity.vinhphuc.musicplayer.repeat";
    public static final String SHUFFLE_ACTION = "com.udacity.vinhphuc.musicplayer.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.udacity.vinhphuc.musicplayer.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.udacity.vinhphuc.musicplayer.updatelockscreen";
    ...
    public static final String CHANNEL_ID = "music_player_channel_01";
    ...
    private static final String SHUTDOWN = "com.udacity.vinhphuc.musicplayer.shutdown";
    ...
    private void setUpMediaSession() {
        ...
        mSession = new MediaSessionCompat(this, "Phonograph", mediaButtonReceiverComponentName, mediaButtonReceiverPendingIntent);
...
//            }
    ...
    private void notifyChange(final String what) {
        ...
        musicIntent.setAction(what.replace(MUSICAPP_PACKAGE_NAME, MUSIC_PACKAGE_NAME));
    ...
    private void createNotificationChannel() {
        if (AppUtils.isOreo()) {
            CharSequence name = "Udacity Music Player";
    ...
    private Notification buildNotification() {
        ...
        Builder builder = new Builder(this, CHANNEL_ID)
                ...
                .setContentTitle(Html.fromHtml("<b>" + getTrackName() + "</b>"))
                .setContentText(text)
            ...
            if (c != null && c.getCount() != 0) {
                ...
                do {
                    TrackItem t = new TrackItem()
                            ...
                            .setDuration(AppUtils.makeShortTimeString(this, c.getInt(c.getColumnIndexOrThrow(AudioColumns.DURATION)) / 1000));
                    list.add(t.get());
                } while (c.moveToNext());
                try {
    ...
    private static final class ServiceStub extends IUdacityMusicService.Stub {
        ...
        public void open(final long[] list, final int position, long sourceId, int sourceType)
            ...
            mService.get().open(list, position, sourceId, AppUtils.IdType.getTypeById(sourceType));
        }
        ...
        public void enqueue(final long[] list, final int action, long sourceId, int sourceType)
                throws RemoteException {
            mService.get().enqueue(list, action, sourceId, AppUtils.IdType.getTypeById(sourceType));
        }
