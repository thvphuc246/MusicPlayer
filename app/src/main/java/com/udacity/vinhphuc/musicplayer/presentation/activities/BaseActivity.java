...
import com.udacity.vinhphuc.musicplayer.IUdacityMusicService;
...
import com.udacity.vinhphuc.musicplayer.presentation.cast.WebServer;
import com.udacity.vinhphuc.musicplayer.presentation.fragments.QuickControlsFragment;
...
import static com.udacity.vinhphuc.musicplayer.MusicPlayer.mService;
...
public class BaseActivity
    ...
    private final SessionManagerListener mSessionManagerListener =
            new SimpleSessionManagerListener();
    ...
    public void onServiceConnected(final ComponentName name, final IBinder service) {
        mService = IUdacityMusicService.Stub.asInterface(service);
        onMetaChanged();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!AppUtils.hasEffectsPanel(BaseActivity.this)) {
    ...
    private class SimpleSessionManagerListener implements SessionManagerListener {
        @Override
