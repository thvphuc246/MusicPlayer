...
import com.udacity.vinhphuc.musicplayer.presentation.adapters.AlbumAdapter;
...
public class AlbumFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.fragment_album_recycler_view, container, false);

        recyclerView = rootView.findViewById(R.id.album_recycler_view);
