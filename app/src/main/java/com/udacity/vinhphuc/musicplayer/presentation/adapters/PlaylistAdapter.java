...
public class PlaylistAdapter extends RecyclerView.Adapter<PlaylistAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        itemHolder.artist.setText(
                " " + String.valueOf(songCountInt) + " " + mContext.getString(R.string.songs)
                + " - " + AppUtils.makeShortTimeString(mContext,totalRuntime)
        );
        ...
        public void onClick(View v) {
            NavigationUtils
                    .navigateToPlaylistDetail(
                            mContext,
                            getPlaylistType(getAdapterPosition()),
                            (long) albumArt.getTag(),
